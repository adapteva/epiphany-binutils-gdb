...
/*----------------------------------------------------------------------------*/
static int
epiphany_in_function_epilogue_p (struct gdbarch *gdbarch,
				 CORE_ADDR       pc)
{
...
}	/* epiphany_in_function_epilogue_p () */
		       ...
		       struct gdbarch_list *arches)
{
  ...
  /* No need for skip_solib_resolver or in_solib_return_trampoline, since no
     shared objects. */
  set_gdbarch_in_function_epilogue_p (gdbarch, epiphany_in_function_epilogue_p);
