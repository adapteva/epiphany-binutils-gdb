...
0000014a \<jalr16\>:
 ...
 14e:	0d52      	jalr r3
 150:	0152      	jalr r0
 152:	1d5f 0402 	jalr fp
 156:	155f 0402 	jalr sp
 15a:	0d52      	jalr r3
 15c:	1d5f 0402 	jalr fp
...
00000164 \<jalr\>:
 ...
 178:	0d5f 0402 	jalr r11
 17c:	115f 0c02 	jalr r28
 180:	0d5f 1c02 	jalr r59

00000184 \<ldrbx16\>:
 184:	9209 2480 	ldrb ip,\[ip,\+ip]
 188:	6d81      	ldrb r3,\[r3,r3]
 18a:	0001      	ldrb r0,\[r0,r0]
 18c:	ff89 2480 	ldrb fp,\[fp,\+fp]
 190:	b689 2480 	ldrb sp,\[sp,\+sp]
 194:	8009 2000 	ldrb ip,\[r0,\+r0]
 198:	6b09 0080 	ldrb r3,\[r2,\+lr]
 19c:	5189 0400 	ldrb r2,\[ip,\+r3]

000001a0 \<ldrbp16\>:
 1a0:	a38d 2080 	ldrb sp,\[r0],\+fp
 1a4:	c60d 2080 	ldrb lr,\[r1],\+ip
 1a8:	e38d 2080 	ldrb fp,\[r0],\+fp

000001ac \<ldrbx\>:
 1ac:	9209 2480 	ldrb ip,\[ip,\+ip]
...
000001cc \<ldrbp\>:
 ...
 1d4:	4c8d e580 	ldrb r58,\[r11],\+r25

000001d8 \<ldrbd16\>:
 1d8:	900c 2400 	ldrb ip,\[ip,\+0x0\]
 1dc:	6f84      	ldrb r3,\[r3,0x7]
 1de:	0204      	ldrb r0,\[r0,0x4]
 1e0:	fd8c 2400 	ldrb fp,\[fp,\+0x3]
...
00000210 \<ldrhx16\>:
 210:	9229 2480 	ldrh ip,\[ip,\+ip]
 214:	6da1      	ldrh r3,\[r3,r3]
 216:	0021      	ldrh r0,\[r0,r0]
 218:	ffa9 2480 	ldrh fp,\[fp,\+fp]
 21c:	b6a9 2480 	ldrh sp,\[sp,\+sp]
 220:	0329 0080 	ldrh r0,\[r0,\+lr]
 224:	daa9 2480 	ldrh lr,\[lr,\+sp]
 228:	1fa9 0480 	ldrh r0,\[fp,\+fp]

0000022c \<ldrhp16\>:
 22c:	57ad 0480 	ldrh r2,\[sp],\+fp
 230:	d7ad 4480 	ldrh r22,\[sp],\+fp

00000234 \<ldrhx\>:
 234:	9229 2480 	ldrh ip,\[ip,\+ip]
...
00000260 \<ldrhd16\>:
 260:	902c 2400 	ldrh ip,\[ip,\+0x0\]
 264:	6fa4      	ldrh r3,\[r3,0x7]
 266:	0224      	ldrh r0,\[r0,0x4]
 268:	fdac 2400 	ldrh fp,\[fp,\+0x3]
...
00000298 \<ldrx16\>:
 298:	9249 2480 	ldr ip,\[ip,\+ip]
 29c:	6dc1      	ldr r3,\[r3,r3]
 29e:	0041      	ldr r0,\[r0,r0]
 2a0:	ffc9 2480 	ldr fp,\[fp,\+fp]
 2a4:	b6c9 2480 	ldr sp,\[sp,\+sp]
 2a8:	7f49 0480 	ldr r3,\[fp,\+lr]
 2ac:	9949 2400 	ldr ip,\[lr,\+r2]
 2b0:	6b49 0080 	ldr r3,\[r2,\+lr]

000002b4 \<ldrp16\>:
 2b4:	decd 2480 	ldr lr,\[fp],\+sp
 2b8:	144d 0400 	ldr r0,\[sp],\+r0
 2bc:	e8cd 2000 	ldr fp,\[r2],\+r1

000002c0 \<ldrx\>:
 2c0:	9249 2480 	ldr ip,\[ip,\+ip]
 ...
 2dc:	dfc9 2600 	ldr lr,\[fp,\+r39]

000002e0 \<ldrp\>:
 2e0:	b74d 4180 	ldr r21,\[r5],\+r30
 2e4:	934d 8480 	ldr r36,\[ip],\+lr
 2e8:	91cd 2080 	ldr ip,\[r4],\+r11

000002ec \<ldrd16\>:
 2ec:	904c 2400 	ldr ip,\[ip,\+0x0\]
 2f0:	6fc4      	ldr r3,\[r3,0x7]
 2f2:	0244      	ldr r0,\[r0,0x4]
 2f4:	fdcc 2400 	ldr fp,\[fp,\+0x3]
 2f8:	b4cc 2400 	ldr sp,\[sp,\+0x1]
 2fc:	144c 0400 	ldr r0,\[sp,\+0x0\]
 300:	87cc 2000 	ldr ip,\[r1,\+0x7]
 304:	e4cc 2000 	ldr fp,\[r1,\+0x1]

00000308 \<ldrd\>:
 308:	904c 2400 	ldr ip,\[ip,\+0x0\]
...
00000328 \<ldrdx16\>:
 328:	9269 2480 	ldrd ip,\[ip,\+ip]
 32c:	8de1      	ldrd r4,\[r3,r3]
 32e:	0061      	ldrd r0,\[r0,r0]
 330:	dfe9 2480 	ldrd lr,\[fp,\+fp]
 334:	16e9 4480 	ldrd r16,\[sp,\+sp]
 338:	ca69 6080 	ldrd r30,\[r2,\+ip]
 33c:	1de9 0400 	ldrd r0,\[fp,\+r3]
 340:	9369 4480 	ldrd r20,\[ip,\+lr]

00000344 \<ldrdp16\>:
 344:	8de5      	ldrd r4,\[r3],r3
 346:	1fed 4480 	ldrd r16,\[fp],\+fp
 34a:	96ed 4480 	ldrd r20,\[sp],\+sp
 34e:	50ed 2400 	ldrd r10,\[ip],\+r1
 352:	df6d 6480 	ldrd r30,\[fp],\+lr
 356:	daed e480 	ldrd r62,\[lr],\+sp

0000035a \<ldrdx\>:
 35a:	9269 2480 	ldrd ip,\[ip,\+ip]
 35e:	4de9 ff80 	ldrd r58,\[r59,\+r59]
 362:	9269 6d80 	ldrd r28,\[r28,\+r28]
 366:	4de9 6d80 	ldrd r26,\[r27,\+r27]
 36a:	96e9 2480 	ldrd ip,\[sp,\+sp]
 36e:	1de9 8780 	ldrd r32,\[fp,\+r59]
...
0000037a \<ldrdp\>:
 ...
 386:	41ed f080 	ldrd r58,\[r32],\+r11

0000038a \<ldrdd16\>:
 38a:	906c 2400 	ldrd ip,\[ip,\+0x0\]
 38e:	8fe4      	ldrd r4,\[r3,0x7]
 390:	0264      	ldrd r0,\[r0,0x4]
 392:	1dec 4400 	ldrd r16,\[fp,\+0x3]
 396:	54ec 4400 	ldrd r18,\[sp,\+0x1]
 39a:	1dec 0400 	ldrd r0,\[fp,\+0x3]
 39e:	dfec 2400 	ldrd lr,\[fp,\+0x7]
 3a2:	d0ec 2400 	ldrd lr,\[ip,\+0x1]

000003a6 \<ldrdd\>:
 3a6:	906c 2400 	ldrd ip,\[ip,\+0x0\]
...
00000456 \<strbd\>:
 ...
 46e:	8e9c 30b6 	strb ip,\[r35,\+0x5b5]
 472:	c91c dc88 	strb r54,\[r58,\+0x442]

00000476 \<strhx16\>:
 476:	9239 2480 	strh ip,\[ip,\+ip]
 47a:	6db1      	strh r3,\[r3,r3]
 47c:	0031      	strh r0,\[r0,r0]
 47e:	ffb9 2480 	strh fp,\[fp,\+fp]
 482:	b6b9 2480 	strh sp,\[sp,\+sp]
 486:	0cb1      	strh r0,\[r3,r1]
 488:	3d39 0400 	strh r1,\[fp,\+r2]
 48c:	6fb9 0080 	strh r3,\[r3,\+fp]

00000490 \<strhx\>:
 490:	9239 2480 	strh ip,\[ip,\+ip]
 ...
 4a8:	1239 8580 	strh r32,\[ip,\+r28]
 4ac:	2cb9 e480 	strh r57,\[r11,\+r9]

000004b0 \<strhp16\>:
 4b0:	923d 2480 	strh ip,\[ip],\+ip
 4b4:	6db5      	strh r3,\[r3],r3
 4b6:	0035      	strh r0,\[r0],r0
 4b8:	ffbd 2480 	strh fp,\[fp],\+fp
...
000004ea \<strhd16\>:
 ...
 4f2:	fdbc 2400 	strh fp,\[fp,\+0x3]
 4f6:	b4bc 2400 	strh sp,\[sp,\+0x1]
 4fa:	61b4      	strh r3,\[r0,0x3]
 4fc:	d3bc 2400 	strh lr,\[ip,\+0x7]
...
00000502 \<strhd\>:
 ...
 51e:	7fbc 244e 	strh r11,\[fp,\+0x277]

00000522 \<strx16\>:
 522:	9259 2480 	str ip,\[ip,\+ip]
 526:	6dd1      	str r3,\[r3,r3]
 528:	0051      	str r0,\[r0,r0]
 52a:	ffd9 2480 	str fp,\[fp,\+fp]
 52e:	b6d9 2480 	str sp,\[sp,\+sp]
 532:	cdd9 2000 	str lr,\[r3,\+r3]
 536:	7c59 0400 	str r3,\[fp,\+r0]
 53a:	94d9 2400 	str ip,\[sp,\+r1]

0000053e \<strx\>:
 53e:	9259 2480 	str ip,\[ip,\+ip]
...
0000059a \<strd16\>:
 ...
 5a2:	fddc 2400 	str fp,\[fp,\+0x3]
 5a6:	b4dc 2400 	str sp,\[sp,\+0x1]
 5aa:	7ddc 0400 	str r3,\[fp,\+0x3]
 5ae:	b35c 2400 	str sp,\[ip,\+0x6]
...
000005d6 \<strdx16\>:
 5d6:	9279 2480 	strd ip,\[ip,\+ip]
 5da:	4df1      	strd r2,\[r3,r3]
 5dc:	0071      	strd r0,\[r0,r0]
 5de:	1ff9 4480 	strd r16,\[fp,\+fp]
 5e2:	56f9 4480 	strd r18,\[sp,\+sp]
 5e6:	8cf9 2000 	strd ip,\[r3,\+r1]
 5ea:	5bf9 0480 	strd r2,\[lr,\+fp]
 5ee:	8979 2000 	strd ip,\[r2,\+r2]

000005f2 \<strdx\>:
 5f2:	9279 2480 	strd ip,\[ip,\+ip]
 ...
 60e:	8b79 2580 	strd ip,\[r10,\+r30]

00000612 \<strdp16\>:
 612:	927d 2480 	strd ip,\[ip],\+ip
 616:	4df5      	strd r2,\[r3],r3
 618:	0075      	strd r0,\[r0],r0
 61a:	dffd 0480 	strd r6,\[fp],\+fp
...
00000680 \<mov16EQ\>:
 680:	900f 2402 	moveq ip,ip
 684:	6c02      	moveq r3,r3
 686:	0002      	moveq r0,r0
 688:	fc0f 2402 	moveq fp,fp
 68c:	b40f 2402 	moveq sp,sp
 690:	880f 2002 	moveq ip,r2
 694:	5c0f 0402 	moveq r2,fp
 698:	f40f 2402 	moveq fp,sp

0000069c \<movEQ\>:
 69c:	900f 2402 	moveq ip,ip
...
000006bc \<mov16NE\>:
 6bc:	901f 2402 	movne ip,ip
 6c0:	6c12      	movne r3,r3
 6c2:	0012      	movne r0,r0
 6c4:	fc1f 2402 	movne fp,fp
 6c8:	b41f 2402 	movne sp,sp
 6cc:	6c12      	movne r3,r3
 6ce:	1c1f 0402 	movne r0,fp
 6d2:	fc1f 2402 	movne fp,fp

000006d6 \<movNE\>:
 6d6:	901f 2402 	movne ip,ip
...
0000072e \<mov16GTU\>:
 72e:	902f 2402 	movgtu ip,ip
 732:	6c22      	movgtu r3,r3
 734:	0022      	movgtu r0,r0
 736:	fc2f 2402 	movgtu fp,fp
 73a:	b42f 2402 	movgtu sp,sp
 73e:	982f 2402 	movgtu ip,lr
 742:	b02f 2402 	movgtu sp,ip
 746:	942f 2402 	movgtu ip,sp

0000074a \<movGTU\>:
 74a:	902f 2402 	movgtu ip,ip
...
0000076a \<mov16GTE\>:
 76a:	907f 2402 	movgte ip,ip
 76e:	6c72      	movgte r3,r3
 770:	0072      	movgte r0,r0
 772:	fc7f 2402 	movgte fp,fp
...
0000086c \<movLTE\>:
 ...
 888:	f49f 3802 	movlte fp,r53

0000088c \<mov16LTEU\>:
 88c:	904f 2402 	movlteu ip,ip
 890:	6c42      	movlteu r3,r3
 892:	0042      	movlteu r0,r0
 894:	fc4f 2402 	movlteu fp,fp
 898:	b44f 2402 	movlteu sp,sp
 89c:	984f 2402 	movlteu ip,lr
 8a0:	4842      	movlteu r2,r2
 8a2:	5c4f 0402 	movlteu r2,fp

000008a6 \<movLTEU\>:
 8a6:	904f 2402 	movlteu ip,ip
...
000008c6 \<mov16B\>:
 8c6:	90ef 2402 	mov ip,ip
 8ca:	6ce2      	mov r3,r3
 8cc:	00e2      	mov r0,r0
 8ce:	fcef 2402 	mov fp,fp
 8d2:	b4ef 2402 	mov sp,sp
 8d6:	84ef 2002 	mov ip,r1
 8da:	80ef 2002 	mov ip,r0
 8de:	10ef 0402 	mov r0,ip

000008e2 \<movB\>:
 8e2:	90ef 2402 	mov ip,ip
 ...
 8fa:	90ef 6402 	mov r28,ip
 8fe:	a8ef 1402 	mov r5,r42

00000902 \<mov16BEQ\>:
 902:	90af 2402 	movbeq ip,ip
 906:	6ca2      	movbeq r3,r3
 908:	00a2      	movbeq r0,r0
 90a:	fcaf 2402 	movbeq fp,fp
 90e:	b4af 2402 	movbeq sp,sp
 912:	c8af 2002 	movbeq lr,r2
 916:	e8af 2002 	movbeq fp,r2
 91a:	84af 2002 	movbeq ip,r1

0000091e \<movBEQ\>:
 91e:	90af 2402 	movbeq ip,ip
...
000009b4 \<mov16BLTE\>:
 9b4:	90df 2402 	movblte ip,ip
 9b8:	6cd2      	movblte r3,r3
 9ba:	00d2      	movblte r0,r0
 9bc:	fcdf 2402 	movblte fp,fp
 9c0:	b4df 2402 	movblte sp,sp
 9c4:	b0df 2402 	movblte sp,ip
 9c8:	1cdf 0402 	movblte r0,fp
 9cc:	14df 0402 	movblte r0,sp

000009d0 \<movBLTE\>:
 9d0:	90df 2402 	movblte ip,ip
...
000009f0 \<movts16\>:
 9f0:	810f 2002 	movts config,ip
 9f4:	750f 0402 	movts ipend,r3
 9f8:	010f 0402 	movts iret,r0
 9fc:	ed0f 2002 	movts debug,fp
 a00:	a50f 2002 	movts status,sp
 a04:	e50f 2002 	movts status,fp
 a08:	e90f 2002 	movts pc,fp
 a0c:	050f 0402 	movts imask,r0

00000a10 \<movts\>:
 a10:	810f 2002 	movts config,ip
 ...
 a2c:	850f 2002 	movts status,ip

00000a30 \<movfs16\>:
 a30:	811f 2002 	movfs ip,config
 a34:	751f 0402 	movfs r3,ipend
 a38:	011f 0402 	movfs r0,iret
 a3c:	ed1f 2002 	movfs fp,debug
...
00000b4e \<orr\>:
 ...
 b66:	e1ff 328a 	orr fp,r32,r43
 b6a:	167f ee8a 	orr r56,r29,r44

00000b6e \<eor16\>:
 b6e:	920f 248a 	eor ip,ip,ip
 b72:	6d8a      	eor r3,r3,r3
 b74:	000a      	eor r0,r0,r0
 b76:	ff8f 248a 	eor fp,fp,fp
 b7a:	b68f 248a 	eor sp,sp,sp
 b7e:	8d0f 200a 	eor ip,r3,r2
 b82:	750f 040a 	eor r3,sp,r2
 b86:	f50f 240a 	eor fp,sp,r2

00000b8a \<eor\>:
 b8a:	920f 248a 	eor ip,ip,ip
 ...
 ba6:	698f 268a 	eor r11,r10,r43

00000baa \<asr16\>:
 baa:	926f 248a 	asr ip,ip,ip
 bae:	6dea      	asr r3,r3,r3
 bb0:	006a      	asr r0,r0,r0
 bb2:	ffef 248a 	asr fp,fp,fp
 bb6:	b6ef 248a 	asr sp,sp,sp
 bba:	61ea      	asr r3,r0,r3
 bbc:	676f 008a 	asr r3,r1,lr
 bc0:	1eef 048a 	asr r0,fp,sp

00000bc4 \<asr\>:
 bc4:	926f 248a 	asr ip,ip,ip
 ...
 be0:	9def 208a 	asr ip,r7,r11

00000be4 \<lsr16\>:
 be4:	924f 248a 	lsr ip,ip,ip
 be8:	6dca      	lsr r3,r3,r3
 bea:	004a      	lsr r0,r0,r0
 bec:	ffcf 248a 	lsr fp,fp,fp
 bf0:	b6cf 248a 	lsr sp,sp,sp
 bf4:	afcf 208a 	lsr sp,r3,fp
 bf8:	e74f 208a 	lsr fp,r1,lr
 bfc:	c94f 200a 	lsr lr,r2,r2

00000c00 \<lsr\>:
 c00:	924f 248a 	lsr ip,ip,ip
 ...
 c18:	984f 3a0a 	lsr ip,r54,r32
 c1c:	b64f 248a 	lsr sp,sp,ip

00000c20 \<lsl16\>:
 c20:	922f 248a 	lsl ip,ip,ip
 c24:	6daa      	lsl r3,r3,r3
 c26:	002a      	lsl r0,r0,r0
 c28:	ffaf 248a 	lsl fp,fp,fp
 c2c:	b6af 248a 	lsl sp,sp,sp
 c30:	922f 248a 	lsl ip,ip,ip
 c34:	c62f 208a 	lsl lr,r1,ip
 c38:	d5af 240a 	lsl lr,sp,r3

00000c3c \<lsl\>:
 c3c:	922f 248a 	lsl ip,ip,ip
 c40:	6daf ff8a 	lsl r59,r59,r59
 c44:	922f 6d8a 	lsl r28,r28,r28
 c48:	6daf 6d8a 	lsl r27,r27,r27
 c4c:	b6af 248a 	lsl sp,sp,sp
 c50:	8faf 948a 	lsl r36,r43,fp
...
00000c5c \<addi16\>:
 ...
 c68:	fd9b 2400 	add fp,fp,3
 c6c:	b49b 2400 	add sp,sp,1
 c70:	6493      	add r3,r1,1
 c72:	3d9b 0400 	add r1,fp,3
 c76:	1f9b 0400 	add r0,fp,7
...
00000d12 \<lsli16\>:
 d12:	901f 2406 	lsl ip,ip,0x0
 d16:	6ff6      	lsl r3,r3,0x1f
 d18:	0216      	lsl r0,r0,0x10
 d1a:	fdff 2406 	lsl fp,fp,0xf
...
00000d2a \<lsli32\>:
 ...
 d46:	519f 0406 	lsl r2,ip,0xc

00000d4a \<asri16\>:
 d4a:	900f 240e 	asr ip,ip,0x0
 d4e:	6fee      	asr r3,r3,0x1f
 d50:	020e      	asr r0,r0,0x10
 d52:	fdef 240e 	asr fp,fp,0xf
 d56:	b42f 240e 	asr sp,sp,0x1
 d5a:	d2af 240e 	asr lr,ip,0x15
 d5e:	6ece      	asr r3,r3,0x16
 d60:	6d2e      	asr r3,r3,0x9

00000d62 \<asri32\>:
 d62:	900f 240e 	asr ip,ip,0x0
...
00000dbc \<faddf16\>:
 dbc:	920f 2487 	fadd ip,ip,ip
 dc0:	6d87      	fadd r3,r3,r3
 dc2:	0007      	fadd r0,r0,r0
 dc4:	ff8f 2487 	fadd fp,fp,fp
 dc8:	b68f 2487 	fadd sp,sp,sp
 dcc:	b10f 2407 	fadd sp,ip,r2
 dd0:	a90f 2007 	fadd sp,r2,r2
 dd4:	bb8f 2487 	fadd sp,lr,fp

00000dd8 \<faddf32\>:
 dd8:	920f 2487 	fadd ip,ip,ip
...
00000e8a \<fmaddf32\>:
 ...
 ea2:	8bbf 2087 	fmadd ip,r2,fp
 ea6:	e33f 3507 	fmadd fp,r40,r22

00000eaa \<fmsubf16\>:
 eaa:	924f 2487 	fmsub ip,ip,ip
 eae:	6dc7      	fmsub r3,r3,r3
 eb0:	0047      	fmsub r0,r0,r0
 eb2:	ffcf 2487 	fmsub fp,fp,fp
 eb6:	b6cf 2487 	fmsub sp,sp,sp
 eba:	bccf 2407 	fmsub sp,fp,r1
 ebe:	3ecf 0487 	fmsub r1,fp,sp
 ec2:	0c47      	fmsub r0,r3,r0

00000ec4 \<fmsubf32\>:
 ec4:	924f 2487 	fmsub ip,ip,ip
 ...
 ee0:	f9cf 2907 	fmsub fp,r22,r19
 ee4:	2a4c 0101 	ldr r1,\[r2,-0xc]
 ee8:	dbbc 4dff 	strh r22,\[r30,-0x7ff]
 eec:	9bec 24ff 	ldrd ip,\[lr,\+0x7ff]
 ef0:	201e      	bitr r1,r0
 ef2:	fc1f 640e 	bitr r31,fp
